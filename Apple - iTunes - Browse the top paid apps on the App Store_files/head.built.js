...
}else{c=AC.Retina.imageComponentRegistry.lookup("img-tag")}}}g.setSrc(h||"https://www.apple.com/global/elements/blank.gif");
...
for(var f=0;f<d.length;f++){c(d[f])}return c})({1:[function(b,d,a){var c=b("./../shared/FeatureDetect");
var f=b("./../shared/fixStorage");var g=(function(){return{initialize:function(){c.htmlClass();
return this}}}());d.exports=g.initialize()},{"./../shared/FeatureDetect":2,"./../shared/fixStorage":3}],2:[function(b,f,a){var g=b("ac-base").Element;
...
},{"ac-base":false}],3:[function(c,d,b){var a=(function(){if(typeof AC.Storage==="object"&&typeof AC.Storage.storageType==="function"&&typeof AC.Storage.IE==="object"&&typeof AC.Storage.IE.element==="function"){if(AC.Storage.storageType()==="localStorage"){AC.Storage.IE.element=function(){if(this._element===null){this._element=document.createElement("div")
